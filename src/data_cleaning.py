...
def data_cleaning(df):
    """
    Function to clean the data, and return a new data frame
    """
    ...
    # only look at used vehicle within price range of 8k-40k
